    ...
    <Row className="align-items-center sh-row"
      data-aos="fade-down-left" data-aos-duration="900" >
          <Col className="text-end">
            <h1 className="section-header sh-right">projects</h1>
          </Col>
    </Row>
    <Row className="mb-5"
    data-aos="fade-down-left" data-aos-duration="1000" >
      <ButtonGroup>
        <Button variant="light" onClick={() => {setProjectsData(devProjectsData); setShowDesignPortfolio(false)}}>development</Button>
        <Button variant="light" onClick={() => {setProjectsData(designProjectsData); setShowDesignPortfolio(true)}}>design</Button>
        <Button variant="light" onClick={() => {setProjectsData(caseStudyProjectsData); setShowDesignPortfolio(false)}}>case studies</Button>
    </ButtonGroup>          
    </Row>
      <Row>
        <Container>
